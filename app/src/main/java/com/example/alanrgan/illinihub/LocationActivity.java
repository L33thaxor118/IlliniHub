...
public abstract class LocationActivity extends AppCompatActivity implements
        OnMapReadyCallback, OnLocationClickListener, PermissionsListener, OnCameraTrackingChangedListener, MapboxMap.OnMapLongClickListener, MapboxMap.OnMapClickListener {
...
//            Toast.makeText(LocationActivity.this, "whatevs",
...
//      });
  ...
  @Override
  public boolean onMapLongClick(LatLng Point) {return false;};

  @Override
  public boolean onMapClick(LatLng Point) {return false;};
